<template>
  <div class="motor__graph-container">
    <canvas :id="`lineChart-temperature-motor${id}`" width="500" height="150"></canvas>
    <p>Temperature (°C)</p>
  </div>
</template>
...
export default {
  ...
  mounted() {
    window['lineChart_temperature_motor' + this.id] = new Chart(
      document.getElementById(`lineChart-temperature-motor${this.id}`),
      {
        type: 'line',
        data: {
          labels: [],
